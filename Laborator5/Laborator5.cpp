...
void Laborator5::Update(float deltaTimeSeconds)
{
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(1.2f, 1.7f, 0));
		modelMatrix = glm::rotate(modelMatrix, glm::radians(60.0f), glm::vec3(1.f, 1.f, 0.f));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(1.5f, 1, 2));
		RenderMesh(meshes["teapot"], shaders["VertexNormal"], modelMatrix);
	}

	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(-1.0f, 2.0f, 0));
		modelMatrix = glm::rotate(modelMatrix, glm::radians(45.0f), glm::vec3(0.8f, 0.f, 0.5f));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f, 1.2f, 1));
		RenderMesh(meshes["teapot"], shaders["VertexNormal"], modelMatrix);
	}
}
