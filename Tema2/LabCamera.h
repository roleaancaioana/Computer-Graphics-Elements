...
namespace Skyroads
{
	...
	public:
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			glm::mat4 rotMat = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0));
			glm::vec4 newFwd = rotMat * glm::vec4(forward, 0);
			this->forward = glm::normalize(glm::vec3(newFwd));
			rotMat = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0));
			newFwd = rotMat * glm::vec4(right, 0);
			this->right = glm::normalize(glm::vec3(newFwd));
			this->up = glm::cross(right, forward);
		}
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			glm::mat4 rotMat = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0));
			glm::vec4 newFwd = rotMat * glm::vec4(right, 1);
			this->right = glm::normalize(glm::vec3(newFwd));

			rotMat = glm::rotate(glm::mat4(1.f), angle, forward);
			newFwd = rotMat * glm::vec4(up, 0);
			this->forward = glm::normalize(glm::vec3(newFwd));
