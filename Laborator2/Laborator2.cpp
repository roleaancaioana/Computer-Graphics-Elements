...
void Laborator2::Init()
{
	...
	}
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(2, 0, 2), glm::vec3(1, 0, 1)),
			VertexFormat(glm::vec3(5, 0, 1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(2, 3, 2), glm::vec3(0, 1, 0)),
		};
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.25f));
	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 1, 0), glm::vec3(0.25f));
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.5f));
